...
MOCK_MODULES = ['logging', 'mdtraj', 'numpy', 'openmmtools', 'parmed', 'pymbar', 'scipy', 'scipy.cluster', 'simtk', 'simtk.openmm', 'simtk.openmm.app']
...
project = 'grand'
copyright = '2020, Marley Samways'
author = 'Marley Samways'
